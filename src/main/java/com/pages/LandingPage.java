...
public class LandingPage extends TestBase {
	...
	// nofification
	@FindBy(xpath = "//p[contains(text(),'Some FedEx and TNT services for Ukraine, Russia an')]")
	WebElement verifyNotification;
	
	@FindBy(xpath = "//span[@class='fxg-alert__close-btn']")
	WebElement closeNotificarionBtn;
	...
	public boolean VerifyNotication()
	{
		return verifyNotification.isDisplayed();
	}
